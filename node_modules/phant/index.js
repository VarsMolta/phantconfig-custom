...
Phant.ConfigStream = require('./lib/config_stream');
...
app.registerInput = function(input) {
  ...
  // listen for stream setup/config event
  input.on('config', this.configStream.bind(this));
 ...
 */
app.configStream = function(id) {

  // loop through all outputs and give
  // them the new data.
  this.outputs.forEach(function(output) {
    output.configStream(id);
  });
